	...
	<div class="probonoseo-cards-wrap">
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_diagnosis_pro_crawl', '有効化', true, !$probonoseo_is_pro_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_diagnosis_pro_mobile', '有効化', true, !$probonoseo_is_pro_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_diagnosis_pro_vitals', '有効化', true, !$probonoseo_is_pro_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_diagnosis_pro_performance', '有効化', true, !$probonoseo_is_pro_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_diagnosis_pro_security', '有効化', true, !$probonoseo_is_pro_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_diagnosis_pro_ssl', '有効化', true, !$probonoseo_is_pro_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_diagnosis_pro_sitemap', '有効化', true, !$probonoseo_is_pro_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_diagnosis_pro_total', '有効化', true, !$probonoseo_is_pro_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_diagnosis_pro_pdf', '有効化', true, !$probonoseo_is_pro_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
