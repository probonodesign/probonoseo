	...
	<div class="probonoseo-cards-wrap">
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_faq', 'FAQ schema', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_howto', 'HowTo schema', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_review', 'Review schema', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_recipe', 'Recipe schema', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_event', 'Event schema', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_product', 'Product schema', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_video', 'Video schema', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_job', 'JobPosting schema', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
	...
	<div class="probonoseo-cards-wrap">
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_sitelinks', 'サイトリンク最適化', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_searchbox', '検索ボックス表示', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_knowledge', 'ナレッジパネル最適化', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_carousel', 'カルーセル表示最適化', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_featured', '強調スニペット最適化', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
	...
	<div class="probonoseo-cards-wrap">
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_local', 'ローカルビジネスschema', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_sitemap', 'サイトマップ高度版', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
	...
	<div class="probonoseo-cards-wrap">
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_faq_auto', 'FAQ自動抽出', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_howto_time', 'HowTo所要時間', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_howto_cost', 'HowTo費用', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_recipe_nutrition', 'Recipe栄養情報', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_recipe_video', 'Recipe動画', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_event_offers', 'Eventチケット', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_video_youtube', 'YouTube検出', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_video_vimeo', 'Vimeo検出', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_sitemap_xml', 'XMLサイトマップ', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_sitemap_html', 'HTMLサイトマップ', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_sitemap_image', '画像サイトマップ', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_sitemap_video', '動画サイトマップ', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
	...
	<div class="probonoseo-cards-wrap">
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_faq_limit_enabled', 'FAQ表示数設定', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_review_scale_enabled', '評価スケール設定', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_review_type_enabled', 'レビュー対象設定', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_event_mode_enabled', '開催形式設定', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_product_currency_enabled', '通貨設定', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_product_availability_enabled', '在庫状況設定', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_job_type_enabled', '雇用形態設定', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_job_remote_enabled', 'リモート設定', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_local_name_enabled', 'ビジネス名設定', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_local_type_enabled', 'タイプ設定', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_local_address_enabled', '住所設定', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_local_phone_enabled', '電話番号設定', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_local_hours_enabled', '営業時間設定', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_sitemap_freq_enabled', '更新頻度設定', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_serp_sitemap_limit_enabled', '最大URL数設定', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
