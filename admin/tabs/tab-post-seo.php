	...
	<div class="probonoseo-cards-wrap">
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_metabox', 'SEOメタボックス', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_score', 'SEOスコア', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_title_preview', 'タイトルプレビュー', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_meta_preview', 'メタDプレビュー', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_serp_preview', 'SERPプレビュー', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_social_preview', 'SNSプレビュー', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_focus_keyword', 'フォーカスキーワード', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_keyword_density', 'キーワード密度', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_internal_links', '内部リンク提案', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_external_links', '外部リンクチェック', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_image_alt', '画像altチェック', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_heading_structure', '見出し構造', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_word_count', '文字数チェック', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_read_time', '読了時間', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_content_score', 'コンテンツスコア', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_suggestions', '改善提案', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_checklist', 'チェックリスト', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_publish_warning', '公開前警告', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
	...
	<div class="probonoseo-cards-wrap">
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_type_post', '投稿', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_type_page', '固定ページ', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_post_seo_type_custom', 'カスタム投稿', true, $probonoseo_is_locked, 'Pro版が必要です'); ?>
				</div>
			</div>
		</div>
