	...
	<div class="probonoseo-cards-wrap">
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_software', 'アプリ情報', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_course', 'コース・講座', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_book', '書籍情報', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_movie', '映画情報', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_music', '音楽情報', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_podcast', 'ポッドキャスト', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_organization', '組織情報', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_person', '人物情報', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_article', '記事詳細', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_news', 'ニュース記事', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_blog', 'ブログ記事', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_announcement', '特別告知', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_image', '画像詳細', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_dataset', 'データセット', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_rating', '集計評価', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_claim', 'ファクトチェック', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_speakable', '音声読み上げ', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_auto_select', '自動選択', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_software_category_enabled', 'Softwareカテゴリ', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_software_os_enabled', 'SoftwareOS', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_software_price_type_enabled', 'Software価格', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_software_currency_enabled', 'デフォルト通貨', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_course_provider_enabled', 'Course提供者', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_course_mode_enabled', 'Course形式', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_book_format_enabled', 'Book形式', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_book_language_enabled', 'デフォルト言語', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_music_type_enabled', 'Musicタイプ', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_podcast_category_enabled', 'Podcastカテゴリ', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_org_type_enabled', 'Orgタイプ', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_org_founded_enabled', 'Org設立年', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_org_address_enabled', 'Org所在地', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_person_job_enabled', 'Person職業', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_person_affiliation_enabled', 'Person所属', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_article_type_enabled', 'Articleタイプ', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_article_author_auto_enabled', 'Article著者自動', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_article_publisher_enabled', 'Article発行者', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_article_logo_enabled', 'Articleロゴ', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_announcement_category_enabled', 'Announcementカテゴリ', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_announcement_expires_enabled', 'Announcement有効日数', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_image_copyright_enabled', 'Image著作権者', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_dataset_creator_enabled', 'Dataset作成者', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_dataset_format_enabled', 'Datasetファイル形式', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_rating_scale_enabled', 'Rating評価スケール', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_rating_item_type_enabled', 'Rating対象タイプ', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_claim_org_enabled', 'ClaimReview組織名', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_claim_rating_enabled', 'ClaimReview検証結果', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_speakable_target_enabled', 'Speakable対象', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_speakable_selector_enabled', 'Speakableセレクタ', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_auto_priority_enabled', '自動選択優先度', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_schema_auto_fallback_enabled', '自動選択フォールバック', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
