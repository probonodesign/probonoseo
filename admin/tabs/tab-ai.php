	...
	<div class="probonoseo-cards-wrap">
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_title_ai', 'タイトル提案AI', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_heading_ai', '見出し改善AI', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_outline_ai', '記事構成案生成AI', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_body_ai', '説明文改善AI', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_summary_ai', '要点サマリー生成', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_faq_ai', 'FAQ 自動生成', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_metadesc_ai', '高品質ディスクリプション', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_keywords_ai', '関連キーワード抽出AI', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_rewrite_ai', 'リライト提案AI', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_readability_ai', '読みやすさチェックAI', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_sentiment_ai', '感情分析AI', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_duplicate_ai', '重複チェックAI', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_target_ai', 'ターゲット読者分析AI', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_intent_ai', '検索意図分析AI', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_gap_ai', 'コンテンツギャップAI', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_caption_ai', '画像キャプションAI', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_internal_link_ai', '内部リンク提案AI', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_external_link_ai', '外部リンク提案AI', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_update_ai', 'コンテンツ更新提案AI', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_performance_ai', 'パフォーマンス予測AI', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
		...
		<div class="probonoseo-card pro-feature">
			<div class="probonoseo-card-inner">
				...
				<div class="probonoseo-card-right">
					<?php probonoseo_render_switch('probonoseo_pro_morphological_analysis', '形態素解析SEO診断', true, !$probonoseo_license_active, 'Pro版の機能です'); ?>
				</div>
			</div>
		</div>
