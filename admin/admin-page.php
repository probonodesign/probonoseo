...
<div class="probonoseo-wrap">
	...
	<div class="probonoseo-header">
		<h1 class="probonoseo-title">ProbonoSEO Pro</h1>
	...
	<nav class="nav-tab-wrapper probonoseo-tabs-all">
		...
		<a href="?page=probonoseo&tab=manual" class="nav-tab nav-tab-manual <?php echo $probonoseo_current_tab === 'manual' ? 'nav-tab-active' : ''; ?>">マニュアル</a>
	</nav>

	<?php if ($probonoseo_current_tab === 'diagnosis' || $probonoseo_current_tab === 'license' || $probonoseo_current_tab === 'openai' || $probonoseo_current_tab === 'info' || $probonoseo_current_tab === 'manual') : ?>
		...
		} elseif ($probonoseo_current_tab === 'manual') {
			require_once PROBONOSEO_PATH . 'admin/tabs/tab-manual.php';
		}
		?>
